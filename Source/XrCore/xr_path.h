///////////////////////////////////////////////////////////
// FX: € устал по кд преобразовывать типы туда <-> обратно
///////////////////////////////////////////////////////////

#pragma once

// std::filesystem::path с поддержкой xr_string.
/// !!!»—ѕќЋ№«ќ¬ј“№ синонемичный xr_path
#include <filesystem>

class XRCORE_API CFilePath : public std::filesystem::path
{
...
public:
	...
	xr_string xstring() const;
	xr_string xfilename() const;

public:
	inherited string() const = delete;
	inherited filename() const = delete;
