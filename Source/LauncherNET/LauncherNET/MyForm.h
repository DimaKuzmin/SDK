...
namespace LauncherNET 
{
	...
	private: System::Windows::Forms::TextBox^ ThreadsCount_DO;

	private: System::Windows::Forms::Button^ DetailsButtonWork;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label10->Location = System::Drawing::Point(7, 66);
			this->label10->Name = L"label10";
			this->label10->Size = System::Drawing::Size(81, 27);
			this->label10->TabIndex = 10;
			this->label10->Text = L"Потоки";
			// 
			// ThreadsCount_DO
			// 
			...
			this->DetailsButtonWork->Text = L"Запустить";
			this->DetailsButtonWork->UseVisualStyleBackColor = true;
			this->DetailsButtonWork->Click += gcnew System::EventHandler(this, &MyForm::DetailsButtonWork_Click);
			// 
			// label11
			// 
			...
			this->label18->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 14.25F, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label18->Location = System::Drawing::Point(599, 28);
			this->label18->Name = L"label18";
			this->label18->Size = System::Drawing::Size(223, 27);
			this->label18->TabIndex = 33;
			this->label18->Text = L"Кол-во RayTrace HITS";
			// 
			// MaxHitsCount
			// 
			this->MaxHitsCount->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->MaxHitsCount->Location = System::Drawing::Point(841, 28);
			this->MaxHitsCount->Name = L"MaxHitsCount";
			this->MaxHitsCount->Size = System::Drawing::Size(200, 34);
			this->MaxHitsCount->TabIndex = 30;
			this->MaxHitsCount->Text = L"32";
			// 
			// groupBox5
			// 
		...
		private: System::Void DetailsButtonWork_Click(System::Object^ sender, System::EventArgs^ e);
