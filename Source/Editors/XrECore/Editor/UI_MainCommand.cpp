...
{
    Msg("Not Implemented: CommandChangeSnap");
    not_implemented();
...
{
    Msg("Not Implemented: CommandMoveCameraTo");
    not_implemented();
...
{
    Msg("Not Implemented: OnCloseCommandListEditor");
    not_implemented();
...
{
    Msg("Not Implemented: CommandEditCommandList");
    not_implemented();
